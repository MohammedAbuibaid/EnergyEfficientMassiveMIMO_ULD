function [AvgEEperBS, AvgURperBS,AvgPtotperBS] = SysOpt_Fixed_M(PLO_Network,PLI_Network,KgOpt,MgOpt,Pc,PmaxPA,loading,lambdaS)
...
while (~Converged)
    ...
    for BSj= 1:19
        ...
        p = Pc/MgOpt;
        for K=1:KgOpt
            [EE(K),UserRate(K),PWR(K)] = EE_R_Ptot_PA(PLO_Network{BSj},PLI_Network{BSj},KgOpt,K,Mc,Md,p,PmaxPA,[]);
        end
